ownerName = ""
ownerEmail = ""
url = "michel-bolzon.ddns.net"
location = "Brazil"

motd = "Bem vindo ao Energy!"
serverName = "Baiak Energy"
loginMessage = "Bem vindo ao Energy!"
